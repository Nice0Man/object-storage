...
import { Computer, ArrowForward } from "@mui/icons-material";
import WidgetWrapper from "./WidgetWrapper";
import { useWidgetRefresh } from "../../../hooks/useWidgetRefresh";
import { apiClient } from "../../../api/client";
import type { DashboardWidget, ServerStats } from "../../../api/types";
...
const ServersWidget: React.FC<ServersWidgetProps> = ({
  widget,
  editMode = false,
  onSettingsClick,
  onVisibilityToggle,
  ...
  const [data, setData] = React.useState<ServerStats | null>(null);

  const fetchData = useCallback(async () => {
    const stats = await apiClient.getServerStats();
    setData(stats);
  }, []);
