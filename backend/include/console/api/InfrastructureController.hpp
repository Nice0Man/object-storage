...
class InfrastructureController : public drogon::HttpController<InfrastructureController> {
  public:
    ...
    // Summary
    ADD_METHOD_TO(InfrastructureController::get_summary, "/api/v1/infrastructure/summary", drogon::Get, "AuthFilter");

    // Server endpoints
    ADD_METHOD_TO(InfrastructureController::list_servers, "/api/v1/infrastructure/servers", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::get_server,
                  "/api/v1/infrastructure/servers/{id}",
                  drogon::Get,
                  "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::add_server, "/api/v1/infrastructure/servers", drogon::Post, "AuthFilter");
    ...
    // Drive endpoints
    ADD_METHOD_TO(InfrastructureController::list_drives, "/api/v1/infrastructure/drives", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::get_drive, "/api/v1/infrastructure/drives/{id}", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::add_drive, "/api/v1/infrastructure/drives", drogon::Post, "AuthFilter");
    ...
    // Pool endpoints
    ADD_METHOD_TO(InfrastructureController::list_pools, "/api/v1/infrastructure/pools", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::get_pool, "/api/v1/infrastructure/pools/{id}", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::configure_pool, "/api/v1/infrastructure/pools", drogon::Post, "AuthFilter");
    ...
    // Healing endpoints
    ADD_METHOD_TO(InfrastructureController::get_heal_status, "/api/v1/infrastructure/heal", drogon::Get, "AuthFilter");
    ADD_METHOD_TO(InfrastructureController::start_heal, "/api/v1/infrastructure/heal", drogon::Post, "AuthFilter");
