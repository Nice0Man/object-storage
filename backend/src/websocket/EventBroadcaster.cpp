...
void
EventBroadcaster::broadcast_bucket_created(const String& bucket_name, const String& region, const String& user) {
...
void
EventBroadcaster::broadcast_bucket_deleted(const String& bucket_name, const String& user) {
...
void
EventBroadcaster::broadcast_object_uploaded(const String& bucket_name,
    ...
    broadcast(event);
    CONSOLE_LOG_INFO("Broadcast: Object '{}' uploaded to '{}' by {}", object_key, bucket_name, user);
}

void
EventBroadcaster::broadcast_object_deleted(const String& bucket_name, const String& object_key, const String& user) {
    ...
    broadcast(event);
    CONSOLE_LOG_INFO("Broadcast: Object '{}' deleted from '{}' by {}", object_key, bucket_name, user);
}

void
EventBroadcaster::broadcast_upload_progress(const String& upload_id,
...
void
EventBroadcaster::broadcast_server_notification(const String& level, const String& message) {
...
Json::Value
EventBroadcaster::create_base_event(const String& event_type, const String& category) {
    Json::Value event;
...
void
EventBroadcaster::broadcast(const Json::Value& event) {
