...
class StatsController : public drogon::HttpController<StatsController> {
  public:
    ...
    // System statistics
    ADD_METHOD_TO(StatsController::get_system_stats,
                  "/api/v1/stats/system",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Storage capacity statistics
    ADD_METHOD_TO(StatsController::get_capacity,
                  "/api/v1/stats/capacity",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Recent activity
    ADD_METHOD_TO(StatsController::get_activity,
                  "/api/v1/stats/activity",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Server statistics
    ADD_METHOD_TO(StatsController::get_servers,
                  "/api/v1/stats/servers",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Drive statistics
    ADD_METHOD_TO(StatsController::get_drives,
                  "/api/v1/stats/drives",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Pool statistics
    ADD_METHOD_TO(StatsController::get_pools,
                  "/api/v1/stats/pools",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // API error statistics
    ADD_METHOD_TO(StatsController::get_api_errors,
                  "/api/v1/stats/api-errors",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Data throughput statistics
    ADD_METHOD_TO(StatsController::get_data_throughput,
                  "/api/v1/stats/data-throughput",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");

    // Encryption statistics
    ADD_METHOD_TO(StatsController::get_encryption_stats,
                  "/api/v1/stats/encryption",
                  drogon::Get,
                  "console::middleware::AuthMiddleware");
